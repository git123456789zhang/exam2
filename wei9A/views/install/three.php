...
<td><input name="db" value="wei9a" size="35" class="txt" type="text"></td>
<td>&nbsp;</td>
</tr>
...
<td><input name="dbtem" value="wei_" size="35" class="txt" type="text"></td>
<td>&nbsp;同一数据库运行多个论坛时，请修改前缀</td>
</tr>
</tbody></table><div class="desc"><b>填写管理员信息</b><br>请牢记 WEI 9A 创始人密码，凭该密码登陆 WEI 9A。</div><table class="tb2">
<tbody>
<tr>
