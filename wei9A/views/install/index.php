...
<tbody><tr>
	<th>项目</th>
	<th class="padleft">WEI 9A 所需配置</th>
	<th class="padleft">最佳</th>
...
<td class="w pdleft1"><?php echo $ret['server']['os']['value']?></td>
</tr>
<tr>
<td>PHP 版本</td>
<td class="padleft">4.0</td>
<td class="padleft">5.0</td>
<td class="w pdleft1"><?php echo $ret['server']['php']['value']?></td>
</tr>
<tr>
<td>附件上传</td>
<td class="padleft">不限制</td>
<td class="padleft">2M</td>
<td class="w pdleft1"><?php echo $ret['server']['upload']['value']?></td>
</tr>
<tr>
<td>GD 库</td>
<td class="padleft">1.0</td>
<td class="padleft">2.0</td>
<td class="w pdleft1"><?php echo  $ret['php']['gd']['ok']=1?'支持':'不支持';?></td>
</tr>
<tr>
<td>磁盘空间</td>
<td class="padleft">10M</td>
<td class="padleft">不限制</td>
<td class="w pdleft1"><?php echo ceil(disk_free_space("/")/1024/1024)?></td>
</tr>
</tbody></table>
...
<?php //print_r($ret['get_defined_functions'])?>
<tr>
<td>mysql_connect()</td>
<td class="w pdleft1"><?php echo  function_exists('mysql_connect')?'true':'falsh';?></td>
<td class="padleft">无</td>
</tr><tr>
<td>gethostbyname()</td>
<td class="w pdleft1"><?php echo  function_exists('gethostbyname')?'true':'falsh';?></td>
<td class="padleft">无</td>
</tr><tr>
<td>file_get_contents()</td>
<td class="w pdleft1"><?php echo  function_exists('file_get_contents')?'true':'falsh';?></td>
<td class="padleft">无</td>
</tr><tr>
<td>xml_parser_create()</td>
<td class="w pdleft1"><?php echo  function_exists('xml_parser_create')?'true':'falsh';?></td>
<td class="padleft">无</td>
</tr></tbody></table>
